package cn.jhsoft.bigdata.hadoop.hbase;
...
public class HbaseTest {
	...
	public void uodateData() throws Exception {
		Put put = new Put(Bytes.toBytes("123421"));
		put.add(Bytes.toBytes("info"), Bytes.toBytes("namessss"), Bytes.toBytes("lisi12343"));
	...
	public void queryData() throws Exception {
		Get get = new Get(Bytes.toBytes("123421"));
	...
	public void scanData() throws Exception {
		...
		scan.setStartRow(Bytes.toBytes("123421"));
		scan.setStopRow(Bytes.toBytes("123425"));
