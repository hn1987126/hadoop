...
import cn.jhsoft.webclick.mrbean.PageViewsBean;
import cn.jhsoft.webclick.mrbean.VisitBean;
...
public class ClickStreamVisit {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.setInputPaths(job, new Path("/wordcount/weblog/output2"));
		FileSystem fs = FileSystem.get(conf);
		Path path = new Path("/wordcount/weblog/output3");
		if (fs.exists(path)){
			fs.delete(path, true);
		}
